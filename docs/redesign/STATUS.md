...
- Scoped re-review of the B1 fix: independently re-verified (0 missing CSS rules on 6/6 pages, 39 focus-visible elements confirmed covered on the homepage, shared stylesheet restored to 49,812 bytes). Verdict: fix clean, no new breakage. FINAL-SIGNOFF.md corrected to reflect B1 resolved. **Pipeline complete. Remaining precondition for merge: B2 (client confirmation of photo usage rights) - not resolvable by this team.**
